...
import { CreateStoreOptions } from "./model";
...
export const optionsErrorHandle = (options?: CreateStoreOptions) => {
  if (options && typeof options?.initialReset !== "boolean") {
    throw new Error("The parameter item initialReset of options needs to be a boolean value.");
  }
};
