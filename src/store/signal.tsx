...
import {
  __DEEP_SPLICE_KEY__, __SIGNAL_SUFFIX_KEY__, __STORE_FN_NAME__, __VIEWER_SUFFIX_KEY__,
} from "./static";
...
const reduceGetDeepValue = <S extends PrimitiveState>(
  keys: string[],
  engineStore: StoreMap<S> | Store<S>,
  ...args: unknown[]
) => keys.reduce((prevValue: any, prop: string) => {
    ...
    // Keep this pointing of internal objects to facilitate subsequent update rendering.
      ? renderValue.bind(engineStore, ...args)()
      : renderValue;
  }, (engineStore as any)[keys[0]]);
      ...
      new Proxy({
        ...
        get(target: any, prop: string | symbol, receiver: any): any {
          ...
          return getDeepValue(
            ...
            store, engineStore, markAsRendering,
            // Detect whether it is a function attribute of the first layer of store
            typeof value === "function" && value[__STORE_FN_NAME__] === __STORE_FN_NAME__
              // function properties of the first layer
              ? ((value as AnyFn).bind(store, ...args)() as ValueOf<S>)
              : value,
          );
        }
      }),
