 ...
 * 
 * B、In addition, due to the special processing of resyView, the data generated by resy can be used to drive updates without first deconstructing at the top of the component
 * This also makes up for the "feature" that resy's data usage needs to be deconstructed at the top level of components.
 */
```
