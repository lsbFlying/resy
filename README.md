...
[![npm](https://img.shields.io/npm/dt/resy?style=flat-square)](https://www.npmtrends.com/resy)
...
const store = createStore<StateType>(
  /**
   * If you have some initialization data state values generated by some complex logic during initialization,
   * you can use the function to handle the return.
   * for example: createStore(() => { ... to do something for return initialStateObject. });
   */
  {
    count: 0,
    text: "hello",
...
function App() {
   ...
   *   // to do something for return initialHookStateObject
   *   return {
...
function App() {
   ...
   * you can use the function to handle the return.
   * for example:
   * const { count, setState } = useConciseState(() => {
