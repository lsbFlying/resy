...
function App() {
   ...
   * 
   * If you don't want to deconstruct first, you can use the API "resyview" to solve the problem of "deconstruct first",
   * The API "resyView" will be introduced in detail later.
   */
  const {
